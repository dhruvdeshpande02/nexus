    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Diploma_percentage', models.DecimalField(decimal_places=2, max_digits=5)),
                ...
                ('SEM_7_sgpa', models.DecimalField(decimal_places=2, max_digits=4)),
                ('SEM_8_sgpa', models.DecimalField(decimal_places=2, max_digits=4)),
                ('AVG_TILL_SEM_cgpa', models.DecimalField(decimal_places=2, max_digits=5)),
                ('AVG_TILL_SEM_percentage', models.DecimalField(decimal_places=2, max_digits=5)),
